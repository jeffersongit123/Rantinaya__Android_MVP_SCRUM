...
/**
 * Clase que define la información relacionada con imágenes de entidades.
 *
 * @property name Nombre de la entidad.
 * @property logo Recurso de imagen del logo de la entidad.
 * @property listImage Lista de recursos de imágenes asociadas a la entidad.
 * @property redes Tripleta que contiene URLs para las redes sociales de la entidad.
 */
class ImagesInfo(
    var name : String,
    var logo : Int,
...
/**
 * Lista estática de información de imágenes para productos.
 */
